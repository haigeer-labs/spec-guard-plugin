...
def guidance(report):
    ...
    for group in report.get("groups", []):
        ...
        groups.append({"layer": group.get("layer"), "modules": group.get("modules", []),
                       "classification": group.get("classification"), "workers": workers,
                       "evidence": group.get("evidence", []), "pathDeclarations": group.get("pathDeclarations", {}),
                       "scopeNotice": group.get("scopeNotice", "")})
